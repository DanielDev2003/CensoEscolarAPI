...
def conversor(csv_file,filtroCol,filtro,colList):
    if os.path.exists(csv_file):
        ...
        with open("instituicoes.json", 'w', encoding='utf-8') as jsonFile:
...
csv_file ="..\microdados_censo_escolar_2024\dados\microdados_ed_basica_2024.csv"
...
if __name__ == "__main__": 
    conversor(csv_file,"SG_UF",'PB',cols) 