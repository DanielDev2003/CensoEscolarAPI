...
def removerFk():
    try:
        ...
        cursor.execute('''
            ...
            DROP CONSTRAINT tb_entidades_co_mesorregiao_fkey;
        ''')

        cursor.execute('''
                ALTER TABLE tb_entidades
                DROP CONSTRAINT tb_entidades_co_microrregiao_fkey;
        ''')
...
def adicionarFk():
    try:
        ...
        cursor.execute('''
            ALTER TABLE tb_entidades
            ADD CONSTRAINT tb_entidades_co_microrregiao_fkey 
        ...
        cursor.execute('''
            ALTER TABLE tb_entidades
            ADD CONSTRAINT tb_entidades_co_mesorregiao_fkey
...
if __name__ == "__main__": 
    ...
    csv_file_2023 = "../microdados_censo_escolar_2023/dados/microdados_ed_basica_2023.csv"
    csv_file_2024 = "../microdados_censo_escolar_2024/dados/microdados_ed_basica_2024.csv"
    
    
    armazenar_microdados_educacao(csv_file_2023,10000)
    armazenar_microdados_educacao(csv_file_2024,10000)
